...
import { HERO_BG_IMG, HERO_STATS, TICKER_ITEMS } from '../data/content'
...
const Hero: React.FC = () => {
      ...
      timers.push(
        setTimeout(() => {
          ...
          const step = (now: number) => {
            ...
            setCounts((c) => {
              const next = [...c]
              next[i] = Math.round(s.target * eased)
              return next
            })
  ...
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-14 pt-40 md:pb-16 md:pt-48">
        ...
        <div className="mt-16 grid grid-cols-2 gap-4 md:grid-cols-4">
          {HERO_STATS.map((s, i) => (
            <div key={s.label} className="stat-card animate-in" style={{ animationDelay: `${0.2 + i * 0.12}s` }}>
              <div className="num">
                {counts[i]}
